  ...
  editor.TraitManager.addType("chart-dataset", {
    ...
    createInput(inputProps) {
      ...
      const changeHandler = function (e) {
        ...
        values.forEach((dataSet) => {
          ...
          // alphaInput.style =
          //   "height: 0.1px; outline: none; border-radius: 1px; appearance: auto; width: 98%;";
    ...
    onEvent(eventProps) {
      ...
      for (let i = 0; i < dataSetNum; i++) {
        ...
        let dataSetLabelInput = elInput.querySelector(
          ".charts__data_set_label_" + i
        );
        ...
        // let dataSetAlphaInput = elInput.querySelector(
        //   ".charts__color_alpha_" + i
        // );
